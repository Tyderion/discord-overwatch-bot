...
var owapi_js_1 = require("../owapi.js");
var discord_js_1 = require("discord.js");
var sanitizeNameForMessage = function (name) { return name.replace('L&#xFA;cio', 'Lúcio').replace('Torbj&#xF6;rn', 'Torbjörn').replace('Torbjoern', 'Torbjörn').replace('Lucio', 'Lúcio').replace('Soldier76', 'Soldier: 76'); };
...
exports.default = new index_js_1.Command({
    ...
    fn: function (argv, context) { return __awaiter(_this, void 0, void 0, function () {
        var nickname, region, battletag, _a, info, allHeroes, playedHeroes, top5, embed, kd, heroDetails;
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            owapi_js_1.getCompInfoProfile(battletag, region),
                            owapi_js_1.getCompInfoAll(battletag, region),
                            owapi_js_1.getPlayedCompHeroes(battletag, region)
                        ])];
                case 2:
                    ...
                    return [4 /*yield*/, owapi_js_1.getCompHeroDetails(battletag, region, top5.map(function (h) { return sanitizeNameForMessage(h.name); }).join(','))];
                case 3:
                    heroDetails = _b.sent();
