            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            owapi_1.getCompInfoProfile(battletag, region),
                            owapi_1.getCompInfoAll(battletag, region),
                            owapi_1.getPlayedCompHeroes(battletag, region)
                        ])];
                case 2:
                    ...
                    return [4 /*yield*/, owapi_1.getCompHeroDetails(battletag, region, top5.map(function (h) { return sanitizeNameForMessage(h.name); }).join(','))];
                case 3:
                    heroDetails = _b.sent();
